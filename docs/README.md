# Documentation MediaBib

Bienvenue dans la documentation de MediaBib, le Système Intégré de Gestion de Bibliothèque open source.
...
| [DEVELOPMENT.md](DEVELOPMENT.md) | Guide du développeur |
| [ACCESSIBILITY.md](ACCESSIBILITY.md) | Conformité accessibilité |
...
- Consultez les [Discussions](https://github.com/votre-repo/mediabib/discussions)
